// Same EIA v2 client as services/fetcher/src/client.ts — duplicated so the
// aggregator can run a standalone Railway bundle without depending on the fetcher package.
